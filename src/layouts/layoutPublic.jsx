...
export default function LayoutPublic({children}) {
    ...
    return (
        <>
            { import.meta.env.VITE_NODE_ENV === "test" && <div className="bg-red-500 text-white text-center py-2 uppercase fixed left-0 right-0 top-0 z-30">Versión de Pruebas</div> }
